...
import (
	...
	"github.com/kerrigell/wadb/ddl"
	"github.com/kerrigell/wadb/infoschema"
...
func checkColumn(colDef *ast.ColumnDef) error {
	...
	case mysql.TypeVarchar:
		...
		// Reference https://github.com/kerrigell/wadb/blob/b091e828cfa1d506b014345fb8337e424a4ab905/ddl/ddl_api.go#L185-L204
		if len(tp.Charset) == 0 {
